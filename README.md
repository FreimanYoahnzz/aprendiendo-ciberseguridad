...
En este repositorio tendré en cuenta mi proceso desde cero para entrar en el mundo de la ciberseguridad, aprender sus fundamentos, aplicaciones y todo aquello a lo cual se aplique, mi meta es aprender todo lo que pueda para ser el mejor en ello.

## Contenido
- Apuntes y notas de los temas que voy estudiando
